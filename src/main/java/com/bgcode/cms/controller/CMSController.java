...
public class CMSController {
	...
	public String getNavCtgrTree(HttpServletRequest request) throws JsonProcessingException {
		System.out.print("******getNavCtgrTree******"+request.getServletContext().getRealPath("/relpath"));
	 ...
	 * 
	 * 文章管理 上传文章、图片文件并保存
	 *<img src="data:image/jpeg;base64,src="data:image/png;base64,
	 *==" data-filename="bg.jpg">
	 *==" data-filename="3af39cbaf93037a2da2d0779b9ba7f3c.png">
	 */
...
//	@ResponseBody
	public String saveArticle(@RequestParam String base64Data, HttpServletRequest request) {
		try {
			...
			try {
				System.out.println(request.getServletContext().getRealPath("/upload/article/pic"));
				FileUtils.writeByteArrayToFile(
						new File(request.getServletContext().getRealPath("/upload/article/pic"), tempFileName), bs);
			} catch (Exception ee) {
